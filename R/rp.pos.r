...
if (layout == "grid")
{
  ...
  pnl <- rp.control()
  rp.grid(pnl, "g1", pos=list(row=0, column=0), bg="red")
  rp.grid(pnl, "g2", pos=list(row=1, column=0), bg="navy")
  rp.grid(pnl, "g3", pos=list(row=2, column=0), bg="green")
  rp.grid(pnl, "g4", pos=list(row=0, column=1, rowspan=4), bg="yellow")
